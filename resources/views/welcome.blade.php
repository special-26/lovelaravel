<x-guest-layout>
    ...
    <div class="relative h-full bg-pattern">
        ...
        <section class="hero-area text-gray-800 h-[50vh] overflow-hidden w-full flex items-center justify-center relative border-b px-4">
            <div class="w-full h-full flex flex-col items-center justify-center max-w-4xl relative">
                ...
                <h2 class="text-[4.5em] font-bold text-center">
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center">
                    <div class="text-4xl/[1.07] font-bold tracking-tight md:text-5xl/[1.07]">
                        <span class="">Templates & Starter Kits</span>
                    </div>
        ...
        <section class="mx-auto max-w-7xl py-12">
            <div class="grid max-w-xl items-start justify-between gap-5">
                <div class="text-4xl/[1.07] font-bold tracking-tight md:text-5xl/[1.07]">
                    <span class="bg-gradient-to-br from-red-500 to-zinc-800 bg-clip-text text-transparent">Packages</span>
                </div>
                <div class="text-lg text-zinc-400/80">Our products engineered to streamline website design and development, empowering you to create stunning digital experiences with ease and efficiency</div>
            </div>
            <div class="mt-16 grid gap-4 lg:grid-cols-5 lg:gap-6 xl:gap-8">
                ss
            </div>
        </section>
