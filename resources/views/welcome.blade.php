<x-guest-layout>
    ...
    <div class="relative h-full bg-pattern">
        ...
        <section class="hero-area text-gray-800 h-[70vh] overflow-hidden w-full flex items-center justify-center relative border-b">
            <div class="w-full h-full flex flex-col items-center justify-center max-w-4xl relative">
                ...
                <h2 class="text-[3.8em] font-bold text-center">
                    Unlock the <span class="italic font-serif border-b-2 border-dotted text-red-500">Potential</span> of <span class="italic font-serif border-b-2 border-dotted text-red-500">Laravel
                    </span> with Love
                </h2>
                <p class="text-center">Launch your Laravel project faster with our collection of handcrafted boilerplates, templates, starter kits, and landing pages. Build powerful, dynamic, high-performance, feature-rich, and SEO-friendly websites, SaaS, landing pages <br/> and more with Laravel.</p>
            </div>
        </section>
        ...
        <section class="relative mx-auto max-w-full h-[70vh] flex flex-col items-center justify-center overflow-hidden  shadow-inner bg-zinc-900">
            ...
            <div class="relative isolate">
                ...
                <div class="mx-auto max-w-3xl text-center">
                    ...
                    <p class="mt-6 text-lg text-zinc-400/80">Have questions or ready to start your next project? Reach out to the Special-26 team today. Whether it's a simple inquiry or a detailed project proposal, we're here to listen, assist, and turn your ideas into reality.</p>
                    <p class="mt-6 text-lg text-zinc-400/80">Contact us now to begin your journey towards digital excellence.</p>
