    ...
    <div class="border-t-2 py-10">
        ...
        <div class="mb-6">
            ...
            <textarea name="comment" rows="4" placeholder="Write your message here" type="text" id="author-comment"
                      class="form-input relative block w-full rounded-md border-0 bg-white px-4 py-4 text-sm text-gray-900 placeholder-gray-400 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-black disabled:cursor-not-allowed disabled:opacity-75"></textarea>
            @error('comment')
        ...
        <div>
            @if(auth()->user()?->canComment())
                <button type="submit"
                        class="g-recaptcha bg-red-600 hover:bg-red-700 rounded-lg px-8 py-4 font-semibold text-white transition-all duration-300"
            ...
            @else
                <a
                        ...
                        class="bg-red-600 hover:bg-red-700 rounded-lg px-8 py-4 font-semibold text-white transition-all duration-300">
                    <span>Login</span>
                </a>
            @endif
        </div>
