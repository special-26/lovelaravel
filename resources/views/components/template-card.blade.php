...
<a class="group flex flex-col h-full border hover:border-transparent hover:shadow-lg transition-all duration-300 rounded-2xl" href="#">
    <div class="p-5">
        <div class="aspect-w-16 aspect-h-11">
            <img class="w-full object-cover rounded-xl h-[45dvh]" src="https://images.unsplash.com/photo-1633114128174-2f8aa49759b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="Image Description">
        </div>
        <div class="mt-6">
